...
export class FavoritesView extends Favorites {
  constructor(root) {
    ...
    this.tbody = this.root.querySelector("table tbody.favs-list");
  ...
  removeAllTr() {
    if (this.entries.length !== 0) {
      this.root.querySelector("table .no-favs").classList.add("hide");
    } else {
      this.root.querySelector("table .no-favs").classList.remove("hide");
    }
